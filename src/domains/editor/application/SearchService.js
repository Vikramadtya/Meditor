...
import { VaultSearchStrategy } from "./VaultSearchStrategy";
import { FolderSearchStrategy } from "./FolderSearchStrategy";
...
class SearchService {
   ...
   * @returns {import("./VaultSearchStrategy").VaultSearchStrategy|import("./FolderSearchStrategy").FolderSearchStrategy}
   * @private
   */
