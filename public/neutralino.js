var Neutralino = (function (e) {
  ...
  function f() {
    ...
    const e = m().split(".")[1];
    ((c = new WebSocket(
      `ws://${window.location.hostname}:${window.NL_PORT}?connectToken=${e}`,
    )),
      (function () {
        if (
          (i("ready", () =>
            t(this, void 0, void 0, function* () {
              if ((yield g(d), !window.NL_EXTENABLED)) return;
              const e = yield n();
              for (const t of e.connected) r("extensionReady", t);
            }),
          ),
        ...
        i("extensionReady", (e) =>
          t(this, void 0, void 0, function* () {
            e.detail in l && (yield g(l[e.detail]), delete l[e.detail]);
          }),
        );
      })(),
      (function () {
        (c.addEventListener("message", (e) => {
          ...
          i.id && i.id in u
            ? ((null === (t = i.data) || void 0 === t ? void 0 : t.error)
                ? (u[i.id].reject(i.data.error),
                  "NE_RT_INVTOKN" == i.data.error.code &&
                    (c.close(),
                ...
                : (null === (n = i.data) || void 0 === n
                    ...
                    : n.success) &&
                  u[i.id].resolve(
                    i.data.hasOwnProperty("returnValue")
                      ? i.data.returnValue
                      : i.data,
                  ),
              delete u[i.id])
  ...
  function p(e, t) {
    return new Promise((n, o) => {
      if ((null == c ? void 0 : c.readyState) != WebSocket.OPEN)
        return (
          (i = { method: e, data: t, resolve: n, reject: o }),
          void d.push(i)
        );
      var i;
      const r = "10000000-1000-4000-8000-100000000000".replace(/[018]/g, (e) =>
        ...
        s = m();
      ((u[r] = { resolve: n, reject: o }),
        c.send(JSON.stringify({ id: r, method: e, data: t, accessToken: s })));
    });
  }
  function g(e) {
  ...
  function w(e, t) {
    return p("filesystem.writeBinaryFile", { path: e, data: a(t) });
  }
  var v = {
    __proto__: null,
    appendBinaryFile: function (e, t) {
      return p("filesystem.appendBinaryFile", { path: e, data: a(t) });
    },
  ...
  var L = {
    ...
    create: function (e, t) {
      return new Promise((n, o) => {
        ...
        for (let e in t) {
          ...
          r += ` --window${"-" + e.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase()}=${i(t[e])}`;
        }
    ...
    setDraggableRegion: function (e) {
      return new Promise((n, o) => {
        ...
        function d(e) {
          return t(this, void 0, void 0, function* () {
            if (c) {
              ...
              return (
                (u = t - (n - 5)),
                void (yield S(e.screenX - r, e.screenY - s))
              );
            }
            ((a = Math.sqrt(
              e.movementX * e.movementX + e.movementY * e.movementY,
            )),
              a >= 10 && ((c = !0), i.setPointerCapture(e.pointerId)));
          });
        }
        function l(e) {
          0 === e.button &&
        ...
        function f(e) {
          (i.removeEventListener("pointermove", d),
            i.releasePointerCapture(e.pointerId));
        }
        (i.addEventListener("pointerdown", l),
          i.addEventListener("pointerup", f),
          T.set(i, { pointerdown: l, pointerup: f }),
    ...
    unsetDraggableRegion: function (e) {
      return new Promise((t, n) => {
        ...
        const { pointerdown: i, pointerup: r } = T.get(o);
    ...
    install: function () {
      return new Promise((e, n) =>
        t(this, void 0, void 0, function* () {
          ...
          try {
            const t = yield fetch(I.resourcesURL),
              n = yield t.arrayBuffer();
            (yield w(window.NL_PATH + "/resources.neu", n),
              e({
                success: !0,
  ...
  var R = {
    ...
    writeImage: function (e) {
      ...
      return (
        (null == e ? void 0 : e.data) && (t.data = a(e.data)),
